...
#define NUM_SAMPLES      10      // number of samples stored in flash RAM
...
prog_uchar *sample_data[NUM_SAMPLES] = {
  ...
  sample4_data, sample5_data, sample6_data, sample7_data, sample8_data, sample9_data
};

//  This one stores the size of each sample
short sample_size[NUM_SAMPLES] = {
  sample0_size, sample1_size, sample2_size, sample3_size,
  sample4_size, sample5_size, sample6_size, sample7_size, sample8_size, sample9_size
};
...
float sample_fs_micro[NUM_SAMPLES] = {
  ...
  sample4_fs_micro, sample5_fs_micro, sample6_fs_micro, sample7_fs_micro, sample8_fs_micro, sample9_fs_micro
};
